...
def main():
    ...
    json_subtitle_file = "transcript.json"
    ...
    try:
        ...
        # 7. Save Final Video
        final_video.write_videofile("merged_output_with_audio_subtitles.mp4", fps=24, codec="libx264", audio_codec="aac")

        # 8. Delete Temporary Files (optional)
        os.remove(audio_path)
        os.remove(video_path)
        os.remove(json_subtitle_file)
